## kubectl-signalfx status

Runs the status command in the specified pod.
...
```
kubectl-signalfx status [flags]
```

### Options

```
  -a, --all          run command on all agent pods
  -h, --help         help for status
  -p, --pod string   agent pod name
```
